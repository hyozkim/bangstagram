...
public class TimelineController {
    ...
    public List<TimelineResponseDto> getTimelineById(@AuthenticationPrincipal JwtAuthentication jwtAuthentication) {
        log.info("[get Timeline]: {}", jwtAuthentication.getId());
        return timelineService.getTimelineByUserId(jwtAuthentication.getId());
    }
}